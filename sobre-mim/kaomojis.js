...
function aplicarKaomoji(texto, kaomojiKey) {
  ...
  var k = KAOMOJI_CATALOG.find(function(x) { return x.key === kaomojiKey; });
  if (!k) return texto;
...
function getKaomojiByKey(key) {
  return KAOMOJI_CATALOG.find(function(x) { return x.key === key; });
}

if (typeof module !== "undefined" && module.exports) {
  module.exports = { KAOMOJI_CATALOG: KAOMOJI_CATALOG, aplicarKaomoji: aplicarKaomoji, getKaomojiByKey: getKaomojiByKey };
}
